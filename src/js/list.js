...
class List {
    ...
    add(audios) {
        ...
        if (wasSingle && this.audios.length > 1) {
            addClass(this.player.container, 'aplayer-withlist');
    ...
    remove(index) {
        ...
        if (this.audios[index]) {
            if (this.audios.length > 1) {
                ...
                if (this.audios.length === 1) {
                    removeClass(this.player.container, 'aplayer-withlist');
                }
    ...
    switch(index) {
        ...
        if (typeof index !== 'undefined' && this.audios[index]) {
            ...
            if (light) {
                removeClass(light, 'aplayer-list-light');
            }
            addClass(this.player.container.querySelectorAll('.aplayer-list li')[this.index], 'aplayer-list-light');
