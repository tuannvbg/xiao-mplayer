...
import { hasClass, removeClass, addClass } from './dom';
...
class Controller {
    ...
    initVolumeButton() {
        ...
        const thumbUp = (e) => {
            removeClass(this.player.template.volumeBarWrap, 'aplayer-volume-bar-wrap-active');
        ...
        this.player.template.volumeBarWrap.addEventListener(utils.nameMap.dragStart, () => {
            addClass(this.player.template.volumeBarWrap, 'aplayer-volume-bar-wrap-active');
    ...
    initLrcButton() {
        this.player.template.lrcButton.addEventListener('click', () => {
            // this.player.template.lrcButton.classList.contains('aplayer-icon-lrc-inactivity')
            if (hasClass(this.player.template.lrcButton, 'aplayer-icon-lrc-inactivity')) {
                removeClass(this.player.template.lrcButton, 'aplayer-icon-lrc-inactivity');

                // this.player.template.lrcButton.classList.remove('aplayer-icon-lrc-inactivity');
                this.player.lrc && this.player.lrc.show();
            } else {
                addClass(this.player.template.lrcButton, 'aplayer-icon-lrc-inactivity');
